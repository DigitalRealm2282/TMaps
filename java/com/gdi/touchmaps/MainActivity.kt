...
import com.gdi.touchmaps.databinding.ActivityMainBinding
import com.gdi.touchmaps.model.User
import com.gdi.touchmaps.service.MyLocationReceiver
...
//    }
    ...
    override fun onFirebaseLoadUserDone(lstEmail: List<String>) {
        Toast.makeText(this, lstEmail.size.toString()+" Emails found",Toast.LENGTH_LONG).show()
